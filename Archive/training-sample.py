...
path_dest = 'C:/Users/chaoj/Desktop/UTMIST/3D-CNN-Gesture-recognition/training_samples/' # The folder where we will put all our training samples
...
count = 0
simple = 350 # number of samples by class for training, total: 2450 training sample
